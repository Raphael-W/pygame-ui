...
class SlidingElement (Element):
    def __init__(self, parent, axis = 'x', value_range = (1, 100), offset = (0, 0), dimensions = (200, 30), stick = "nesw", *, handle_length = 0, value = 0, increment = 1, action = None, finished_action = None, show = True, disabled = False, child_index = -1):
