...
class ImageButton(Button):
    ...
    def __init__(self, parent, source, offset = (0, 0), dimensions = (100, 30), stick = "", *, image_scale = 1, image_rotation = 0, image_offset = (0, 0), action = None, show = True, disabled = False, styling = None, child_index = -1):
