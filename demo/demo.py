...
Slider(main_layer, (0, 100), (550, 50), (150, 10), 2, "nw", bar_color = (180, 180, 180), handle_color = (36, 155, 199), suffix = "%", increment = 2)
Switch(main_layer, (800, 50), 1, "nw")
TextInput(main_layer, (900, 50), "nw", length = 200, font_size = 20, placeholder = "Search")

TextButton(main_layer, "Show message", (30, 150), (200, 50), "nw", action = lambda: Message(main_layer, "Message Test", "This is a message box", ("Okay", None)))
